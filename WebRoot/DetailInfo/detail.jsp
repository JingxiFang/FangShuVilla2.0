		...
		<div class="row">
			<div class="row animate-box" style="margin-top:60px">
				<div class="col-md-12 col-md-offset-0 text-center fh5co-heading">
					<h2>
						<span style="font-family:'幼圆';">实拍展示</span>
					</h2>
				</div>
			</div>
		</div>
...
<!-- -----------------------------------------------------------代理人-------------------------------------------------- -->
					...
					<div class="col-md-3">
						<div class="side animate-box">
							...
							<div class="fh5co-staff">
								...
								<input type="button" id="ThumbButton" class="btn btn-primary" value="💗点赞" onclick="getThumb(<%=houseinfo.getAgent().getId()%>)">
				...
				%>
							<div class="blog-entry">
								 <img src="<%=house.getOnePicAdd()%>"
									class="img-responsive" alt="">
									<div class="desc">
										<span class="date"><%=house.getH_address()%></span>
										<h3><%=house.getName()%></h3>
									</div>
							</div>
							<%}} %>
...
<!-- -----------------------------------------------------------代理人结束-------------------------------------------------- -->
	...
	var PSV = new PhotoSphereViewer({
			panorama: 'DetailInfo/images/sun.jpg',
			container: div,
			time_anim: 3000,
			navbar: true,
			navbar_style: {
