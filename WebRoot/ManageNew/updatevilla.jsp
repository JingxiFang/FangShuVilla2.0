...
<%@page import="cn.sdcet.project.service.PictureService"%>
<%
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<%
          //	HouseDetailInfo houseDet=(HouseDetailInfo)request.getAttribute("houseInfo");
          	HouseDetailInfo houseDet=(HouseDetailInfo)session.getAttribute("houseInfo");
          //	List<String> listPic =(List<String>) request.getAttribute("listPic");
          			List<String> listPic =(List<String>) session.getAttribute("listPic");
   			 %>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  ...
                  	  <input type="hidden" name="hiddenId" value="<%=houseDet.getHouse().getId()%>"/>
