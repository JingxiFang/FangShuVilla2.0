...
public class HouseInfoService {
	 ...
	 * @return
	 */
	public String setFineHouse(int houseid) {
		HouseInfoJDBCImpl houseInfoDao=new HouseInfoJDBCImpl();
		HouseDetailInfoDao   hdd=new HouseDetailInfoDaoJDBCImpl();
		int flag=hdd.getHouseInfoDetail(houseid).getHouse().getFineFlag();
		if( hdd.getHouseInfoDetail(houseid).getHouse().getFineFlag()==1){
			if( houseInfoDao.cancelFineHouse(houseid))
			{
				return "取消成功";
			}
		}	
		else{
			if(houseInfoDao.setFineHouse(houseid)){
				return "设置成功";
			}
	 ...
	 * @return
	 */
	public boolean cancelFineHouse(int houseid) {
		HouseInfoJDBCImpl houseInfoDao=new HouseInfoJDBCImpl();
	 ...
	 * @return
	 */
	public boolean deHouseOrderCount(int houseid){
		HouseInfoJDBCImpl houseInfoDao=new HouseInfoJDBCImpl();
		return houseInfoDao.deHouseOrderCount(houseid);
	}
