...
public class AgentInfoDaoJDBCImpl implements AgentInfoDao {
	...
	public boolean isAgent(int userId) {
		...
		String sql="select count(*) as COUNT from agentinfo where agentid=? and flag=1";
	...
	public AgentInfo getAgentOfHot() {
		String sql="select top 1 u.HEAD,u.NAME,a.THUMBCOUNT,a.AGENTID,count(h.AGENTID)as HOUSECOUNT from " +
				...
				"group by u.HEAD,a.THUMBCOUNT,a.AGENTID ,u.NAME, flag having flag=1"+
				"order by a.THUMBCOUNT desc ";
	...
	public List<AgentInfo> getAgentOfTopFive() {
		String sql="select top 5 * from AgentInfo a inner join UserInfo u " +
				"on a.AGENTID=u.USERID where flag=1 order by a.THUMBCOUNT desc ";
		List<AgentInfo> agentList=new ArrayList<AgentInfo>();
		List<Map<String,Object>> list = new ArrayList<Map<String,Object>>();
	...
	public boolean isAgentAgo(int agentId) {
		String sql="select count(*) as COUNT from AgentInfo where AGENTID=? and FLAG=0";
		List<Object> params =new ArrayList<Object>();
		params.add(agentId);
		Map<String,Object> map=new HashMap<String,Object>();
		map=SqlHelper.returnSimpleResult(sql, params);
	...
	public boolean setAgentInfoByUpdate(int agentId) {
		String sql="update agentinfo set flag=1 where agentId=? ";
		List<Object> params =new ArrayList<Object>();
		params.add(agentId);
		return SqlHelper.Execute(sql, params);
	}
	...
	public boolean haveHouse(int agentid) {
		String sql="select count(*) as COUNT from HouseDetailInfo where AGENTID=?";
		List<Object> params =new ArrayList<Object>();
		params.add(agentid);
		Map<String,Object> map=new HashMap<String,Object>();
		map=SqlHelper.returnSimpleResult(sql, params);
